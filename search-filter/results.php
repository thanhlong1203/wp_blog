...
if ( $query->have_posts() ) {
	...
	while ( $query->have_posts() ) {
		...
		?>
	    <div class="relative mx-auto w-full card-project">
            <a href="<?php the_permalink(); ?>" class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                <div class="  bg-white">
                    <div class="flex justify-center relative  overflow-hidden h-[350px]"> 
	...
	?>
    <div class="pagination-project"><?php pmc_pagination($query); ?></div>
	<?php
} else {
